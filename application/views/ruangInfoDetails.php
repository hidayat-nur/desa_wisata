	  	...
	  	<div class="row">
		    ...
		    <div class="col-sm-9">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $daftarRuangInfoDetails->nama ?></li>
                </ul>
		    	<div>
                    <div class="hero-unit">
                        <h3><?php echo $daftarRuangInfoDetails->nama ?></h3>
                        <p style="margin-top: 20px"><?php echo $daftarRuangInfoDetails->deskripsi ?></p>
                    </div>
				</div>
		    </div>
